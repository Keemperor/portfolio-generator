...
<h2 class="text-dark bg-primary p2 display-inline-block">About Me</h2>
<p>${aboutText}</p>
</section>
`
};

// conventional method, without ES6 map and filter concatenated
...
//  ES6 method with map and filter concatenated
